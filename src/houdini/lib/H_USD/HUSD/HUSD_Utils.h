...
enum HUSD_OverridesLayerId {
    ...
    HUSD_OVERRIDES_EXPANSION_LAYER = 1,
    HUSD_OVERRIDES_PURPOSE_LAYER = 2,
    HUSD_OVERRIDES_SOLO_LIGHTS_LAYER = 3,
    HUSD_OVERRIDES_SOLO_GEOMETRY_LAYER = 4,
    HUSD_OVERRIDES_SELECTABLE_LAYER = 5,
    HUSD_OVERRIDES_BASE_LAYER = 6
};
#define HUSD_OVERRIDES_NUM_LAYERS 7
