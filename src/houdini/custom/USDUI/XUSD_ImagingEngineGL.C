...
using _RenderInstanceAppSceneIndicesTracker = HdUtils::RenderInstanceTracker<
        UsdImagingGLEngine_Impl::_AppSceneIndices>;
...
void
XUSD_ImagingEngineGL::_SetActiveRenderSettingsPrimFromStageMetadata(
...
void
XUSD_ImagingEngineGL::_RegisterApplicationSceneIndices()
{
    // SGSI
    {
        ...
        HdSceneIndexPluginRegistry::GetInstance().RegisterSceneIndexForRenderer(
                ...
                &XUSD_ImagingEngineGL::_AppendSceneGlobalsSceneIndexCallback,
                /* inputArgs = */ nullptr,
                insertionPhase,
...
HdSceneIndexBaseRefPtr
XUSD_ImagingEngineGL::_AppendOverridesSceneIndices(
    ...
    HdPluginRenderDelegateUniqueHandle &&renderDelegate)
{
    ...
    // Create a human-readable unique identifier for this instance
    // (in particular this is useful for a Hydra Scene Index Browser,
    //  which identifies Scene Index chains based on the value
    //  passed to HdSceneIndexNameRegistry::RegisterNamedSceneIndex
    //  via the HdSceneIndexAdapterSceneDelegate constructor
    //  via the HdRenderIndex constructor just below)
    const std::string renderInstanceId =
            TfStringPrintf("%s (%p)",
                           renderDelegate->GetRendererDisplayName().c_str(),
    ...
    if (_GetUseSceneIndices()) {
        ...
        info.displayUnloadedPrimsWithBounds = _displayUnloaded;
...
void
XUSD_ImagingEngineGL::SetActiveRenderSettingsPrimPath(SdfPath const &path)
{
